...
input_file  <- "~/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/PennState/AssistantProfessor/BLUE_Shared_Folder/Methods/LiCOR_Respiration/PeakFinderAlgorithm/PeakFinderRepo/Day1_T0_LICOR_GW_SP.txt"

#Where you want this data to be saved; make sure it corresponds to your file system.
output_file <- "~/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/PennState/AssistantProfessor/BLUE_Shared_Folder/Methods/LiCOR_Respiration/PeakFinderAlgorithm/PeakFinderRepo/OutputFolder/Day1_T0_LICOR_CO2_peak_summary.csv"
